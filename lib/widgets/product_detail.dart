...
class ProductDetailCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var currentBgPercentageColor = SysifosColors.brandSuccessColor;
    var currentTextPercentageColor = SysifosColors.brandOnSuccessColor;
    var currentIcon = iconIncomes;
    if (typeProductDetailCard == TypeProductDetailCard.outcomes) {
      currentBgPercentageColor = SysifosColors.brandErrorColor;
      currentTextPercentageColor = SysifosColors.brandOnErrorColor;
